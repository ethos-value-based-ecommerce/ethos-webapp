...
const Footer = () => {
     const footerStyle = {
                backgroundColor: 'var(--deep-taupe)',
                color: 'white',
    ...
    return(
        <AntFooter style={footerStyle}>
            ...
            <Divider style={{ borderColor: 'var(--rosy-beige)', opacity: 0.3, margin: '32px 0 16px' }} />
            ...
            <Row justify="space-between" align="middle">
                ...
                <Col>
                    <Space size="large">
                        <Link href="#" style={{ color: 'var(--light-taupe)', fontSize: '18px' }}>
                            <TwitterOutlined />
                        </Link>
                        <Link href="#" style={{ color: 'var(--light-taupe)', fontSize: '18px' }}>
                            <FacebookOutlined />
